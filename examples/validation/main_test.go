...
func Test_Validate_Berglas(t *testing.T) {
	t.Run("secret resource has berglas reference", func(t *testing.T) {
		...
		validator := &BerglasValidator{logger: logger}
		...
		_, result ,err := validator.Validate(ctx, &secret)
		if err != nil {
			t.Fatal(err)
		}
...
func Test_Validate_BerglasLess(t *testing.T) {
